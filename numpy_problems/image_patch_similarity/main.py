...
def extract_patches(image_array, h_patch_size=16, w_patch_size=16):
...
def get_reference_patch(patches, h_patches, w_patches, h_patch_index=11, w_patch_index=5):
...
def return_similar_patches(image_array, sim_across_channels, topk=15, h_patch_size=64, w_patch_size=64):
...
def plot_similar_patches(image_array, similar_patches, h_patch_index, w_patch_index, h_patch_size=16, w_patch_size=16):
...
print(patches.shape)
reference_patch,h_patch_index, w_patch_index =  get_reference_patch(patches, h_patches, w_patches, h_patch_index=45, w_patch_index=30)
...
similar_patches = return_similar_patches(image_array, similarity_matrix, topk=150, h_patch_size=16, w_patch_size=16)
